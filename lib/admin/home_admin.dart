                ...
                child: Center(
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.asset("images/salad.png", height: 100, width: 100, fit: BoxFit.cover,),
                      ),),
                  SizedBox(width: 30.0,) ,
                  Expanded(child: Text("Add Food Items", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold),)) ],),
                  ),
                ),
              ),
            )
